export const metadata = {
  title: "Nosotros | Ticonomia",
  description: "Aprende más sobre el equipo detrás de Ticonomia.",
};
  ...
  return (
    <div className="w-full flex flex-col gap-12 animate-in fade-in zoom-in duration-500">
      <div className="text-center max-w-2xl mx-auto mt-8">
        <h1 className="text-4xl font-extrabold tracking-tight mb-4">Sobre Ticonomia</h1>
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              El proyecto comenzó como una idea sencilla: eliminar las conjeturas al cambiar divisas. Recopilar tipos de cambio diarios manualmente es tedioso. Ticonomia automatiza este proceso de forma nativa.
            </p>
          </div>
